...
#Preview {
    TaskDetailsView(taskViewModel: TaskViewModel(), Selectedtask: .constant(Task.createMockTasks().first!), showTaskDetailsView: .constant(false), refreshTaskList: .constant(false))
}
